...
<body>
    <div class="container">
        <h1>Formulario Para Subir Imagen De Avatares</h1>
        <form id="registroFormAvatar" enctype="multipart/form-data" method="POST">
    ...
    <script>
        const form = document.getElementById('registroFormAvatar');
        ...
        form.addEventListener('submit', async function (event) {
            ...
            try {
                const response = await fetch('uploads/guardar1.php', {
                    method: 'POST',
                    body: formData,
                });
