...
// Obtener los datos del usuario, incluyendo el mundo actual
$sql = $con->prepare("SELECT u.username, u.puntos, n.nom_nivel, a.foto AS afoto, a.Nom_avatar, m.Nom_mundo, m.Foto AS mfoto 
                      FROM usuario u 
                      INNER JOIN niveles n ON u.puntos >= n.Puntos 
                      INNER JOIN avatar a ON u.Id_avatar = a.Id_avatar
                      INNER JOIN mundo m ON u.Id_mundo = m.Id_mundo 
                      WHERE u.username = ? 
        ...
        <div class="contenedor-opciones">
            <div class="fila">
                <div class="opcion" id="seleccion_avatara">
                        <a class="subrayado" href="ventanachimba.php">
                            <p>AVATAR</p>
